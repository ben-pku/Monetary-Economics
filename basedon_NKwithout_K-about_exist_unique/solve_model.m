...
%     end
    ...
    % solve it
    [G1,C,impact,fmat,fwt,ywt,gev,eu,loose,Q1,Q2]=gensys(A_1,A_2,zeros(3, 0),A_3,A_4);
...
%     end
    ...
    % solve it
    [G1,C,impact,fmat,fwt,ywt,gev,eu,loose,Q1,Q2]=gensys(A_1,A_2,zeros(2, 0),A_3,A_4);
    ...
    % solve it
    [G1,C,impact,fmat,fwt,ywt,gev,eu,loose,Q1,Q2]=gensys(A_1,A_2,zeros(5, 0),A_3,A_4);
