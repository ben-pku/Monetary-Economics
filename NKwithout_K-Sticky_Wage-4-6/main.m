...
para.theta = 6;
para.omega = 2/3;
para.omega_bar = 2/3;  % set by Huang Zhuokai  -- sticky wage parameter -- prob measure of stiff wage
para.nu = 5; % set by Huang Zhuokai  -- sticky wage parameter
para.phi_pi = 1.5;
para.phi_x = 1/8;
para.phi_w = 1/9; % set by Zhuokai Huang
para.rho_v = 0.5; 
para.rho_z = 0.5;
