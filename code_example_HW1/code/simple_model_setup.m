function [A_1, A_2, A_3, A_4] = simple_model_setup(para, ss)
    % set up input matrices for genesis
    ...
    % equation 1
    A_1(1, idx_m) = para.ces_b *ss_Q;
    A_1(1, idx_c) = -para.ces_b *ss_Q;
    A_1(1, idx_z) = (1/para.beta+para.delta-1)*para.beta;

    A_2(1, idx_m) = para.ces_b *ss_Q;
    A_2(1, idx_c) = -para.ces_b *ss_Q;
    A_2(1, idx_k) = -(1/para.beta+para.delta-1)*para.beta*(para.alpha-1);

    A_4(1, idx_m_err) = para.ces_b *ss_Q;
    A_4(1, idx_c_err) = -para.ces_b *ss_Q;
    ...
    % equation 3
    A_1(3, idx_m) = para.ces_b *ss_Q;
    A_1(3, idx_c) = -para.ces_b *ss_Q;
    A_1(3, idx_pi) = -1/(1+ss.pi);

    A_2(3, idx_m) = para.ces_b *ss_Q;
    A_2(3, idx_c) = -para.ces_b *ss_Q;
    A_2(3, idx_i) = -1/(1+ss.i);

    A_4(3, idx_m_err) = para.ces_b *ss_Q;
    A_4(3, idx_c_err) = -para.ces_b *ss_Q;
