...
M_.param_names(6) = {'yk_ss'};
M_.param_names_tex(6) = {'yk\_ss'};
M_.param_names_long(6) = {'yk_ss'};
M_.param_names(7) = {'r_ss'};
M_.param_names_tex(7) = {'r\_ss'};
M_.param_names_long(7) = {'r_ss'};
M_.param_names(8) = {'ck_ss'};
M_.param_names_tex(8) = {'ck\_ss'};
M_.param_names_long(8) = {'ck_ss'};
M_.param_names(9) = {'sig_a'};
M_.param_names_tex(9) = {'sig\_a'};
M_.param_names_long(9) = {'sig_a'};
...
M_.mapping.y.eqidx = [2 3 4 5 ];
M_.mapping.lab.eqidx = [2 4 ];
...
r_ss = M_.params(7);
M_.params(6) = (M_.params(7)-(1-M_.params(4)))/M_.params(5);
yk_ss = M_.params(6);
M_.params(8) = M_.params(6)-M_.params(4);
ck_ss = M_.params(8);
M_.params(9) = 1;
sig_a = M_.params(9);
%
...
save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'untitled_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
