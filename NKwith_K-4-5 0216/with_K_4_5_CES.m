...
para.ss_n = 1; % set by Bo Hu
%para.chi = 1; % set by Huang Zhuokai  -- this para will be solved in this model
...
[G1, impact,ss] = solve_model_ces(para);
irf1 = model_irf_ces(G1, impact, para,ss, shock_v);

fprintf("v-shock   alpha = 2/3 \n")
para.alpha = 2/3;
%get the G1, impact to solve the dynamics process
[G1, impact,ss] = solve_model_ces(para);
irf2 = model_irf_ces(G1, impact, para,ss, shock_v);
...
%get the G1, impact to solve the dynamics process
[G1, impact,ss] = solve_model_ces(para);
irf3 = model_irf_ces(G1, impact, para,ss, shock_z);

fprintf("z-shock   alpha = 2/3\n")
para.alpha = 2/3;
%get the G1, impact to solve the dynamics process
[G1, impact,ss] = solve_model_ces(para);
irf4 = model_irf_ces(G1, impact, para,ss, shock_z);
