%% code for with K 4-5 Cobb-Douglas production fucntion -- Prof. Bo Hu  & Huang Zhuokai
% edited 2022 0226
clear;
format long
%% parameter
...
%para.chi = 1; %set by Huang Zhuokai  -- chi will be solved in this revision model
